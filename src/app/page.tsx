    ...
    <main className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-apple-blue to-apple-purple dark:from-fintech-dark-accent dark:to-indigo-600 rounded-2xl mb-4 shadow-apple-lg dark:shadow-fintech-glow">
