...
TAREFA:
Extraia TODAS as compras/lançamentos do documento, na ordem em que aparecem. NÃO agrupe nem descarte linhas parecidas — é normal haver várias compras diferentes no mesmo mercado no mês, cada uma é um item separado.
