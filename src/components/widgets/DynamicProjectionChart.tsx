  ...
  return (
    <div className="fintech-card p-4 sm:p-6 rounded-2xl">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-semibold fintech-text-primary">📈 Projeção: (Receitas - Investimentos) - Despesas (Inclui Mês Anterior)</h3>
          <p className="text-sm fintech-text-muted mt-1">Saldo acumulado considerando investimentos como redução de receitas</p>
        </div>
      </div>
